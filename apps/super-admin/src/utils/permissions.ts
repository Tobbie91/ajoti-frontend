...
const ALL_PERMISSIONS: Permission[] = [
  ...
  'MANAGE_KYC', 'VIEW_AUDIT_LOGS', 'MANAGE_ACCOUNT_CLOSURES',
...
const ROLE_PERMISSIONS: Record<StaffRole, Permission[]> = {
  ...
  COMPLIANCE: [
    'READ_PLATFORM_DATA', 'MANAGE_TICKETS', 'EDIT_USER_CONTACT_DETAILS', 'SUSPEND_ACCOUNT',
    'MANAGE_KYC', 'VIEW_AUDIT_LOGS', 'MANAGE_ACCOUNT_CLOSURES', 'VIEW_SYSTEM_ACCOUNTS',
  ],
  OPERATIONS: [
    'READ_PLATFORM_DATA', 'MANAGE_TICKETS', 'EDIT_USER_CONTACT_DETAILS', 'SUSPEND_ACCOUNT',
    'MANAGE_KYC', 'VIEW_AUDIT_LOGS', 'MANAGE_ACCOUNT_CLOSURES', 'MANAGE_COLLATERAL', 'MANAGE_CIRCLES',
    'REVERSE_TRANSACTIONS', 'VIEW_LEDGER', 'EXPORT_LEDGER',
    'VIEW_SYSTEM_ACCOUNTS', 'MANAGE_SYSTEM_ACCOUNTS',
  ],
  MANAGER: [
    'READ_PLATFORM_DATA', 'MANAGE_TICKETS', 'EDIT_USER_CONTACT_DETAILS', 'SUSPEND_ACCOUNT',
    'MANAGE_KYC', 'VIEW_AUDIT_LOGS', 'MANAGE_ACCOUNT_CLOSURES', 'MANAGE_ADMIN_ACCOUNTS', 'MANAGE_COLLATERAL',
