    ...
    return (
        <div className="mx-auto w-full max-w-[720px] py-2">
            ...
            {accountStatus === "FROZEN" && (
                <div className="mb-6 flex items-start gap-3 rounded-2xl border border-[#FED7AA] bg-[#FFF7ED] p-4">
                    ...
                    <div>
                        ...
                        <Text
                            fw={400}
                            className="mt-0.5 text-[12px] text-[#9A3412]"
                        >
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                            <Text
                                fw={700}
                                className="truncate text-[18px] text-[#0F172A]"
                            >
                                {fullName}
                            </Text>
                            <Badge
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                    {kycApproved ? (
                        <div className="flex w-fit items-center gap-1.5 rounded-full bg-[#F0FDF4] px-3 py-1">
                            ...
                            <Text
                                fw={500}
                                className="text-[11px] text-[#02A36E]"
                            >
                                KYC Verified
                            </Text>
                        </div>
                        ...
                        >
                            ...
                            <Text
                                fw={500}
                                className="text-[11px] text-[#92400E]"
                            >
            ...
            <div className="mb-5 rounded-2xl border border-[#E5E7EB] bg-white p-6">
                <Text fw={700} className="mb-5 text-[15px] text-[#0F172A]">
                    Personal Information
                </Text>
                <div className="flex flex-col gap-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <Text
                                fw={500}
                                className="mb-1.5 text-[12px] text-[#6B7280]"
                            >
                                First Name
                            </Text>
                            {editing && !nameLocked ? (
                    ...
                    {editing && nameLocked && (
                        ...
                        >
                            Your name is verified with your BVN/NIN and can no
                            longer be changed here. Contact support if it needs
                            correcting.
                        </Text>
                    )}
                    ...
                    {editing && (
                        <Text
                            ...
                            className="-mt-2 text-[11px] text-[#9CA3AF]"
                        >
                            Your email and phone number can&apos;t be changed
                            here. Contact support to update them.
                        </Text>
                    )}
            ...
            <div className="mb-5 rounded-2xl border border-[#E5E7EB] bg-white p-6">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    {editing && (address || city || state || lga) && (
                        <Text
                            fw={400}
                            className="-mt-2 text-[11px] text-[#9CA3AF]"
                        >
                            Your residential address can&apos;t be changed here.
            ...
            {/* KYC / Verification */}
            <div className="mb-5 rounded-2xl border border-[#E5E7EB] bg-white p-6">
                <Text fw={700} className="mb-4 text-[15px] text-[#0F172A]">
                    Verification Status
                </Text>
                ...
                {(() => {
                    ...
                    const tierLabel =
                        ["Unverified", "Level 1", "Level 2", "Level 3"][
                            level
                        ] ?? `Level ${level}`;
                    const tierColor =
                        ["#F59E0B", "#02A36E", "#2563EB", "#7C3AED"][level] ??
                        "#02A36E";
                    const tierBg =
                        ["#FEF3C7", "#F0FDF4", "#EFF6FF", "#EDE9FE"][level] ??
                        "#F0FDF4";
                        ...
                        <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex items-center justify-between rounded-xl bg-[#F9FAFB] px-4 py-3">
                                        ...
                                        {kycStatus?.ninVerified ? (
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                <Text
                                                    fw={500}
                                                    className="text-[12px] text-[#02A36E]"
                                                >
                                                    Verified
                                                </Text>
                                            </div>
                            ...
                            {level >= 1 &&
                                ...
                                step !== "PROOF_OF_ADDRESS_REQUIRED" && (
                                    <div className="rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] p-4">
                                        <Text
                                            fw={600}
                                            className="mb-1 text-[13px] text-[#0F172A]"
                                        >
                                            Upgrade to Level {level + 1}
                                        </Text>
                                        <Text
                                            fw={400}
                                            className="mb-3 text-[12px] text-[#6B7280]"
                                        >
                                            Increase your limits to{" "}
                                            <strong>
                                                {nextLimits[level]?.single}
                                            </strong>{" "}
                                            per transaction and{" "}
                                            <strong>
                                                {nextLimits[level]?.daily}
                                            </strong>{" "}
                                            daily.
                                        </Text>
                                        <button
                            ...
                            {level >= 3 && (
                                <div className="flex items-center gap-2 rounded-xl border border-[#D1FAE5] bg-[#F0FDF4] px-4 py-3">
                                    ...
                                    >
                                        Your identity is fully verified. Maximum
                                        limits unlocked.
                                    </Text>
                                </div>
                            )}
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <Text
                                ...
                                className="text-[12px] text-[#6B7280]"
                            >
                                Set or change your withdrawal PIN
                            </Text>
                        </div>
                    </div>
                        ...
                        {bankAccounts.map((acc) => (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <button
                                        onClick={() =>
                                            handleRemoveBankAccount(acc.id)
                                        }
            ...
            >
                {emailModalStep === "password" ? (
                    <div className="flex flex-col gap-4">
                        <Text fw={400} className="text-[13px] text-[#6B7280]">
                            To update your email address to{" "}
                            <strong>{email}</strong>, please enter your current
                            account password.
                        </Text>
                        <div>
                            <Text
                    ...
                    <div className="flex flex-col gap-4">
                        <Text fw={400} className="text-[13px] text-[#6B7280]">
                            ...
                            <strong>{email}</strong>. Enter it below to complete
                            the change.
                        </Text>
                ...
                <div className="mb-4 rounded-2xl border border-[#FED7AA] bg-white p-5">
                    ...
                    >
                        <div className="text-left">
                            <Text
                                fw={600}
                                className="text-[14px] text-[#EA580C]"
                            >
                                Freeze My Account
                            </Text>
                            <Text
                            ...
                            >
                                Temporarily lock down sensitive actions if you
                    ...
                    {freezeExpanded && (
                        <div className="mt-4 flex flex-col gap-4">
                            <div className="rounded-xl bg-[#FFF7ED] px-4 py-3">
                                ...
                                <Text
                                    fw={600}
                                    className="mt-3 text-[12px] text-[#9A3412]"
                                >
                                    While frozen, you can still:
                                </Text>
                                <ul className="mt-1 list-disc pl-4 text-[12px] text-[#9A3412]">
                                    <li>
                                        Log in and view your account, balances,
                                        and transaction history
                                    </li>
                                    <li>
                                        Receive ajo payouts into your wallet
                                    </li>
                                    <li>
                                        Make contributions to your ajo circles
                                    </li>
                                </ul>
                                <Text
                                    fw={600}
                                ...
                                <ul className="mt-1 list-disc pl-4 text-[12px] text-[#9A3412]">
                                    ...
                                    <li>
                                        Add, remove, or change saved bank
                                        accounts
                                    </li>
                                    <li>
                                        Change your email, phone number,
                                        password, or transaction PIN
                                    </li>
                                </ul>
                                <Text
                                    fw={400}
                            ...
                            <div>
                                ...
                                <TextInput
                                    ...
                                    value={freezeReason}
                                    onChange={(e) =>
                                        setFreezeReason(e.currentTarget.value)
                                    }
                                    radius="md"
                                    size="sm"
                                    styles={{
                            ...
                            <div>
                                ...
                                <PasswordInput
                                    ...
                                    onChange={(e) =>
                                        setFreezePassword(e.currentTarget.value)
                                    }
                                    radius="md"
                                    size="sm"
                                    leftSection={
                ...
                {deleteExpanded && (
                    <div className="mt-4 flex flex-col gap-4">
                        <Text fw={400} className="text-[12px] text-[#6B7280]">
                            This permanently closes your account, deletes your
                            data, and cannot be undone. Make sure your wallet
                            balance is zero and you have no active circle
