...
export function CowrywiseTestMode({ plans }: { plans: TargetSavingsPlan[] }) {
  ...
  const mockEligible = isDevAuthBypass && eligible.length === 0 ? [{
    id: "local-mock-target",
