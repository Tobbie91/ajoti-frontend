...
const USER_APP_URL =
    import.meta.env.VITE_USER_APP_URL ?? "https://user.ajoti.com";
...
export function Kyc() {
    ...
    async function handleVerifyBvn() {
        ...
        try {
            ...
            setKycError(
                err instanceof Error ? err.message : "BVN verification failed",
            );
        } finally {
        ...
        return (
            <div className="flex min-h-screen flex-col items-center justify-center bg-[#F9FAFB] px-6">
                <div className="w-full max-w-[460px] rounded-3xl border border-[#E5E7EB] bg-white p-10 text-center shadow-sm">
                    ...
                    <Text
                        fw={400}
                        className="mt-2 text-[14px] leading-relaxed text-[#6B7280]"
                    >
                        Your KYC documents are under review. You'll be notified
                        once your admin account is approved — this usually takes
                        less than 24 hours.
                    </Text>
                    <a
                        href={USER_APP_URL}
            ...
            <div className="flex min-h-screen flex-col items-center justify-center bg-[#F9FAFB] px-6">
                <div className="w-full max-w-[460px] rounded-3xl border border-[#E5E7EB] bg-white p-10 text-center shadow-sm">
                    ...
                    <Text
                        ...
                        className="mt-2 text-[14px] leading-relaxed text-[#6B7280]"
                    >
                        Your identity has been verified (KYC Level 1). Your
                        admin account is now pending review — you'll be notified
                        once it's approved.
                    </Text>
                    ...
                    <div className="mt-6 rounded-2xl border border-[#E5E7EB] bg-[#F9FAFB] px-5 py-4 text-left">
                        ...
                        <ul className="mt-2 space-y-1.5 text-[13px] text-[#6B7280]">
                            <li>
                                • Our team will review and activate your admin
                                account
                            </li>
                            <li>
                            ...
                            <li>
                                • To increase your transaction limits, upgrade
                                your KYC in the member app
                            </li>
                        </ul>
                    </div>
            ...
            <div className="mx-auto max-w-[600px] px-6 py-8">
                ...
                <div className="mb-6 rounded-xl border border-[#D1FAE5] bg-[#F0FDF4] p-4">
                    ...
                    <Text fw={400} className="mt-1 text-[12px] text-[#6B7280]">
                        Complete all 3 steps to gain access to the admin
                        dashboard and group management tools.
                    </Text>
                </div>
                    ...
                    <div className="rounded-2xl border border-[#E5E7EB] bg-white p-6">
                        <div className="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                >
                                    Enter your 11-digit National Identification
                                    Number
                                </Text>
                            </div>
                        </div>
                            ...
                            {ninVerified ? (
                                <div className="flex items-center gap-3 rounded-xl border border-[#D1FAE5] bg-[#F0FDF4] p-4">
                                    ...
                                    <div>
                                        <Text
                                            fw={600}
                                            className="text-[14px] text-[#065F46]"
                                        >
                        ...
                        <div className="mt-6 rounded-xl bg-[#F9FAFB] p-4">
                            <Text
                                fw={500}
                                className="mb-1 text-[12px] text-[#374151]"
                            >
                            ...
                            >
                                Your NIN is on your National ID card, or dial
                                *346# on your registered phone number.
                            </Text>
                        </div>
                    </div>
                )}
                    ...
                    <div className="rounded-2xl border border-[#E5E7EB] bg-white p-6">
                        ...
                        <div className="mt-6 rounded-xl bg-[#F9FAFB] p-4">
                            ...
                            <Text
                                ...
                                className="text-[12px] leading-[1.6] text-[#6B7280]"
                            >
                                Dial *565*0# on your registered phone number, or
                                check your bank app/statement.
                            </Text>
                        </div>
                    </div>
                )}
                    ...
                    <div className="rounded-2xl border border-[#E5E7EB] bg-white p-6">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    setKinRelationship(e.currentTarget.value)
                                }
                                styles={inputStyles}
                                required
                            />
                            <TextInput
                                ...
                                value={kinPhone}
                                onChange={(e) =>
                                    setKinPhone(e.currentTarget.value)
                                }
                                styles={inputStyles}
                                leftSection={
                            ...
                            <TextInput
                                ...
                                value={kinEmail}
                                onChange={(e) =>
                                    setKinEmail(e.currentTarget.value)
                                }
                                styles={inputStyles}
                            />
                        </div>
