          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center">
              <div className="relative z-10 flex-1 p-6 sm:p-10">
                ...
                <Text
                  fw={700}
                  className="mt-3 text-[20px] leading-tight text-white sm:mt-4 sm:text-[26px]"
                >
                  {featured.title}
                </Text>
                <Text
                  fw={400}
                  className="mt-2 text-[13px] leading-relaxed text-white/85 sm:mt-3 sm:max-w-[440px] sm:text-[14px]"
                >
                  {featured.excerpt}
                </Text>
            ...
            {rest.map((article) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge
                      ...
                      styles={{
                        root: {
                          backgroundColor:
                            categoryBadgeColors[article.category].bg,
                  ...
                  <Text
                    fw={700}
                    className="mt-3 text-[15px] leading-snug text-[#0F172A]"
                  >
                    {article.title}
                  </Text>
                  ...
                  <Text
                    fw={400}
                    className="mt-2 flex-1 text-[13px] leading-relaxed text-[#6B7280]"
                  >
                    {article.excerpt}
                  </Text>
