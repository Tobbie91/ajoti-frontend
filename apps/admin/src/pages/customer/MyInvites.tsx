      ...
      <div className="flex flex-col gap-6">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-4">
            {invites.map((invite) => {
              const amountNaira =
                Number(invite.circle.contributionAmount) / 100;
              const adminName =
                `${invite.circle.admin.firstName} ${invite.circle.admin.lastName}`.trim();
              ...
              const slotsLeft =
                invite.circle.maxSlots - invite.circle.filledSlots;
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        >
                          ...
                          {invite.circle.frequency.toLowerCase()} &middot;{" "}
                          {invite.circle.durationCycles} cycles
                        </Text>
                        <Text
                          fw={500}
                          className="mt-1 text-[12px] text-[#6B7280]"
                        >
                          Admin: {adminName} &middot; {slotsLeft} slot
                          {slotsLeft !== 1 ? "s" : ""} left
                        </Text>
