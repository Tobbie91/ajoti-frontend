...
const {authRequest}=createApiClient({baseUrl:import.meta.env.VITE_API_BASE_URL??'',storagePrefix:'',sessionExpiredRedirect:'/login',extraSessionKeys:['kyc_completed','verify_email','reset_email','pending_redirect']})
