...
const SERVICE_FEE_RATE = 0.02 // 2% service fee on early payout

// Mock active ROSCA groups the user belongs to
const ACTIVE_GROUPS = [
  {
    id: '1',
    name: 'Ajoti Savers Circle',
    contribution: 50_000,
    frequency: 'Monthly',
    totalMembers: 6,
            ...
            <div className="flex flex-col items-center gap-6 pt-8">
              ...
              <div className="flex w-full max-w-[400px] gap-3">
                <button
                  ...
                  className="flex-1 cursor-pointer rounded-xl bg-[#9CA3AF] py-3.5 text-[14px] font-semibold text-white hover:bg-[#6B7280]"
                >
                  Back to Home
                </button>
                {!hasActiveGroups && (
                  <button
                    ...
                    className="flex-1 cursor-pointer rounded-xl bg-[#02A36E] py-3.5 text-[14px] font-semibold text-white hover:bg-[#028a5b]"
                  >
                    Browse Groups
                  </button>
                )}
