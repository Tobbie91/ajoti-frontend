  ...
  if (verifying) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-[#F9FAFB] px-4">
        ...
        <Text fw={500} className="mt-4 text-[15px] text-[#374151]">
          Verifying payment...
        </Text>
      </div>
    )
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-[#F9FAFB] px-4">
        <div className="w-full max-w-[400px] rounded-2xl bg-white p-8 shadow-sm">
          ...
          <Text fw={700} className="mb-2 text-center text-[22px] text-[#0F172A]">
            Payment Successful!
          </Text>
          <Text fw={400} className="mb-6 text-center text-[14px] text-[#6B7280]">
            {method === 'BANK_TRANSFER'
              ? 'Your transfer details have been noted. Your wallet will be credited once the transfer is confirmed.'
          ...
          {txRef && (
            <div className="mb-6 rounded-xl bg-[#F9FAFB] px-4 py-3">
              ...
              <Text fw={600} className="text-center text-[13px] text-[#374151]">
                {txRef}
              </Text>
            </div>
          )}
