...
export function SetPin() {
  ...
  function appendDigit(value: string, setter: (v: string) => void, digit: string): string {
  ...
  function onCurrentDigit(d: string) {
    const next = appendDigit(currentPin, setCurrentPin, d)
    setCurrentPin(next)
  ...
  function onNewDigit(d: string) {
    const next = appendDigit(newPin, setNewPin, d)
    setNewPin(next)
